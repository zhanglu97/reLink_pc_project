    ...
    <div class="SystemUser">
        ...
        <div class="Search_Top_Input">
            <div class="search_list" style="width: calc(100% - 200px) !important">
                ...
                <div class="input_flex">
                    <el-select clearable v-model="searchInput2" placeholder="部门">
                        <el-option label="生产部" value="生产部"></el-option>
                        <el-option label="工艺部" value="工艺部"></el-option>
                    </el-select>
                </div>
                <div class="input_flex">
                    <el-select clearable v-model="searchInput3" placeholder="分组">
                        <el-option label="机加组" value="机加组"></el-option>
                        <el-option label="焊接组" value="焊接组"></el-option>
                        <el-option label="钣金组" value="钣金组"></el-option>
                    </el-select>
                </div>
                <div class="input_flex">
                    <el-select clearable v-model="searchInput4" placeholder="角色">
        ...
        <div class="zll-dialog">
            <popout :title="title + '用户'" :visible.sync="addDialog" v-if="addDialog" >
        ...
        data(){
            return {
                ...
                tableData: [{
                    ...
                    tableNum4: '李维恭',//姓名
                    tableNum5: 'liwg',//用户名
                    tableNum6: '2020-12-12 13:01',//注册日期
                    tableNum7: '正常',//状态
                }, {
                    tableNum1: '生产部',//部门
                    tableNum2: '焊接组',//分组
                    ...
                    tableNum4: '孙小香',//姓名
                    tableNum5: 'sunxx',//用户名
                    tableNum6: '2020-12-12 14:01',//注册日期
                    tableNum7: '正常',//状态
                }, {
                    tableNum1: '生产部',//部门
                    tableNum2: '钣金组',//分组
                    tableNum3: '工作员',//角色
                    tableNum4: '张三',//姓名
                    tableNum5: 'zhangs',//用户名
                    tableNum6: '2020-12-13 14:01',//注册日期
                    tableNum7: '正常',//状态
                }, {
                    tableNum1: '工艺部',//部门
                    tableNum2: '工艺1组',//分组
