            ...
            <el-form :model="addForm" :rules="rules" ref="addForm" class="demo-ruleForm">
                <el-row :gutter="20">
                    <el-col :span="12">
                        ...
                        <el-form-item class="formList" prop="addFormData2" label="分组：">
                            <el-input clearable class="input_right" placeholder="请输入分组" v-model="addForm.addFormData2"></el-input>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item class="formList" prop="addFormData7" label="状态：">
                            <el-select clearable v-model="addForm.addFormData7" placeholder="请选择状态">
